...
#define RADIATOR_COOLDOWN_TIME (100000 * portTICK_PERIOD_MS) // 5 minutes

// Any temperature inbetween these two values is considered a transition state
#define RADIATOR_OPERATING_TEMP 87.0  // (F) if the radiator is above this temp, it is considered on
#define RADIATOR_COOLDOWN_TEMP  66.0  // (F) if the radiator is below this temp, it is considered off
